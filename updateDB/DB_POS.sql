...
CREATE TABLE IF NOT EXISTS `gudang` (
  ...
  `gudang_nama` varchar(50) DEFAULT NULL,
  `gudang_alamat` varchar(50) DEFAULT NULL,
  `gudang_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
...
INSERT INTO `gudang` (`gudang_id`, `gudang_nama`, `gudang_alamat`, `gudang_status`) VALUES
	...
	(5, 'Rizal', 'sfafa', 'Aktif'),
	(6, 'PT. JAYA ABADI', 'Surabaya Barat', 'Aktif');

-- Dumping structure for table db_pos_uas.hak_akses
CREATE TABLE IF NOT EXISTS `hak_akses` (
  `hak_akses_id` int(11) NOT NULL AUTO_INCREMENT,
  `hak_akses_nama` varchar(50) DEFAULT NULL,
  `hak_akses_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
...
-- Dumping structure for procedure db_pos_uas.insertPembelian
DELIMITER //
...
-- Dumping structure for procedure db_pos_uas.insertPembelianDetail
DELIMITER //
CREATE PROCEDURE `insertPembelianDetail`(
		IN lastInserted INT,
        IN produkId INT,
        IN satuanId INT,
...
CREATE TABLE IF NOT EXISTS `kartu_stok` (
  ...
  `kstok_jenis` enum('masuk','keluar') DEFAULT NULL,
  `kstok_nomor_faktur` char(50) DEFAULT NULL,
...
-- Dumping data for table db_pos_uas.kartu_stok: ~17 rows (approximately)
INSERT INTO `kartu_stok` (`kstok_id`, `kstok_jenis`, `kstok_nomor_faktur`, `kstok_detail_faktur_id`, `kstok_produk_id`, `kstok_satuan_id`, `kstok_jumlah`, `kstok_gudang_id`) VALUES
	...
	(14, 'masuk', 'PB009', 9, 8, 10, 1, 1),
	(15, 'masuk', 'PB009', 10, 8, 10, 1, 2),
	(16, 'keluar', 'PJ0013', 41, 6, 1, 5, 1),
	(17, 'keluar', 'PJ0013', 42, 6, 1, 2, 1),
	(18, 'keluar', 'PJ0014', 43, 11, 4, 5, 1),
	(19, 'masuk', 'PB010', 11, 12, 2, 5, 1),
	(20, 'keluar', 'PJ0012', 44, 5, 1, 5, 1),
	(21, 'keluar', 'PJ0012', 45, 5, 1, 10, 1),
	(22, 'keluar', 'PJ0012', 46, 7, 3, 5, 1),
	(23, 'keluar', 'PJ0012', 47, 11, 4, 5, 1),
	(24, 'keluar', 'PJ0012', 48, 8, 10, 10, 1),
	(25, 'keluar', 'PJ0012', 49, 7, 3, 5, 1),
	(26, 'keluar', 'PJ0015', 50, 7, 4, 5, 6),
	(27, 'masuk', 'PB011', 12, 6, 1, 9, 3);
...
CREATE TABLE IF NOT EXISTS `karyawan` (
  ...
  `karyawan_tlp` char(50) DEFAULT NULL,
  `karyawan_jenis_kelamin` enum('L','P') DEFAULT NULL,
  `karyawan_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pelanggan` (
  ...
  `pelanggan_tlp` char(50) DEFAULT NULL,
  `pelanggan_jenis_kelamin` enum('L','P') DEFAULT NULL,
...
INSERT INTO `pelanggan` (`pelanggan_id`, `pelanggan_nama`, `pelanggan_alamat`, `pelanggan_tlp`, `pelanggan_jenis_kelamin`, `pelanggan_status`) VALUES
	...
	(7, 'Ahmad', 'sukolilo', '123456789', 'L', 'Aktif');

-- Dumping structure for table db_pos_uas.pemasok
CREATE TABLE IF NOT EXISTS `pemasok` (
  `pemasok_id` int(11) NOT NULL AUTO_INCREMENT,
  `pemasok_nama` varchar(50) DEFAULT NULL,
  `pemasok_alamat` varchar(50) DEFAULT NULL,
  `pemasok_tlp` char(20) DEFAULT NULL,
...
-- Dumping data for table db_pos_uas.pembelian: ~9 rows (approximately)
INSERT INTO `pembelian` (`pembelian_id`, `pembelian_nomor_faktur`, `pembelian_tanggal`, `pembelian_pemasok_id`, `pembelian_gudang_id`, `pembelian_total_rp`) VALUES
	...
	(9, 'PB009', '2024-01-10', 2, 2, 10000),
	(10, 'PB010', '2024-01-10', 4, 1, 50000),
	(11, 'PB011', '2024-06-11', 5, 3, 445000);
...
-- Dumping data for table db_pos_uas.pembelian_detail: ~8 rows (approximately)
INSERT INTO `pembelian_detail` (`pbeli_detail_id`, `pbeli_detail_pembelian_id`, `pbeli_detail_produk_id`, `pbeli_detail_satuan_id`, `pbeli_detail_harga`, `pbeli_detail_jumlah`, `pbeli_detail_diskon_rp`, `pbeli_detail_persen`, `pbeli_detail_subtotal`) VALUES
	...
	(10, 9, 8, 10, 10000, 1, 0, 0, 10000),
	(11, 10, 12, 2, 10000, 5, 0, 0, 50000),
	(12, 11, 6, 1, 50000, 9, 0, 10, 445000);

-- Dumping structure for table db_pos_uas.penjualan
CREATE TABLE IF NOT EXISTS `penjualan` (
  `penjualan_id` int(11) NOT NULL AUTO_INCREMENT,
  `penjualan_nomor_faktur` char(50) DEFAULT NULL,
  ...
  `penjualan_cara_bayar` enum('Tunai','Kartu','Transfer') DEFAULT NULL,
  `penjualan_kembalian_rp` float DEFAULT NULL,
  `penjualan_keterangan` varchar(250) DEFAULT NULL,
...
-- Dumping data for table db_pos_uas.penjualan: ~14 rows (approximately)
INSERT INTO `penjualan` (`penjualan_id`, `penjualan_nomor_faktur`, `penjualan_tanggal`, `penjualan_pelanggan_id`, `penjualan_gudang_id`, `penjualan_total_rp`, `penjualan_bayar_rp`, `penjualan_cara_bayar`, `penjualan_kembalian_rp`, `penjualan_keterangan`) VALUES
	...
	(15, 'PJ0012', '2024-01-08', 4, 1, 350000, 1000000, 'Tunai', 650000, ''),
	(16, 'PJ0013', '2024-01-10', 3, 1, 100000, 300000, 'Tunai', 200000, 'Keren cak'),
	(17, 'PJ0014', '2024-01-10', 1, 1, 250000, 500000, 'Tunai', 250000, ''),
	(18, 'PJ0015', '2024-06-11', 7, 6, 74250, 100000, 'Tunai', 25750, 'Masih Bagus');
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Dumping data for table db_pos_uas.penjualan_detail: ~15 rows (approximately)
INSERT INTO `penjualan_detail` (`pjual_detail_id`, `pjual_detail_penjualan_id`, `pjual_detail_produk_id`, `pjual_detail_satuan_id`, `pjual_detail_harga`, `pjual_detail_jumlah`, `pjual_detail_diskon_rp`, `pjual_detail_diskon_persen`, `pjual_detail_subtotal`) VALUES
	...
	(42, 16, 6, 1, 50000, 2, 0, 0, 100000),
	(43, 17, 11, 4, 50000, 5, 0, 0, 250000),
	(47, 15, 11, 4, 50000, 5, 0, 0, 250000),
	(48, 15, 8, 10, 10000, 10, 0, 500, 50000),
	(49, 15, 7, 3, 10000, 5, 0, 0, 50000),
	(50, 18, 7, 4, 15000, 5, 0, 5, 74250);

-- Dumping structure for table db_pos_uas.produk
CREATE TABLE IF NOT EXISTS `produk` (
  `produk_id` int(11) NOT NULL AUTO_INCREMENT,
  `produk_kode` varchar(50) NOT NULL DEFAULT '0',
  `produk_nama` varchar(50) DEFAULT NULL,
  `produk_keterangan` varchar(100) DEFAULT NULL,
  `produk_kategori_id` int(11) DEFAULT NULL,
  `produk_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
...
INSERT INTO `produk` (`produk_id`, `produk_kode`, `produk_nama`, `produk_keterangan`, `produk_kategori_id`, `produk_status`) VALUES
	...
	(11, 'BS001', 'Besi Karat', 'Kurang Layak untuk Kapal', 6, 'Aktif'),
	(12, 'PS001', 'Plastik Tebal', 'Layak untuk di pakai', 7, 'Aktif'),
	(13, 'BS002', 'Besi Tua', 'Masih Bagus', 6, 'Aktif');
...
CREATE TABLE IF NOT EXISTS `produk_detail` (
  ...
  `pdetail_default` enum('Ya','Tidak') DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `produk_kategori` (
  ...
  `kategori_kode` char(5) DEFAULT NULL,
  `kategori_nama` varchar(50) DEFAULT NULL,
  `kategori_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
  PRIMARY KEY (`kategori_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=armscii8 COLLATE=armscii8_bin;

-- Dumping data for table db_pos_uas.produk_kategori: ~7 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `produk_satuan` (
  ...
  `satuan_kode` char(5) DEFAULT NULL,
  `satuan_nama` varchar(100) DEFAULT NULL,
  `satuan_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
...
BEGIN
    ...
    WHERE penjualan_tanggal BETWEEN tanggalAwal AND tanggalAkhir;
END//
DELIMITER ;
...
-- Dumping structure for procedure db_pos_uas.SearchTransaksiPembelian
DELIMITER //
CREATE PROCEDURE `SearchTransaksiPembelian`(IN cariData VARCHAR(255))
BEGIN
	IF (cariData != '') THEN
...
-- Dumping structure for procedure db_pos_uas.searchTransaksiPembelianDetail
DELIMITER //
CREATE PROCEDURE `searchTransaksiPembelianDetail`(IN pembelianId VARCHAR(255))
BEGIN
	SELECT 
...
-- Dumping structure for procedure db_pos_uas.updatePembelian
DELIMITER //
CREATE PROCEDURE `updatePembelian`(
		IN nomorFakturPembelianValue VARCHAR(255),
        IN tanggalPembelianValue VARCHAR(255),
        IN pemasokIdPembelianValue INT,
        IN gudangIdPembelianValue INT,
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `user_status` enum('Aktif','Tidak Aktif') DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `user` (`user_id`, `user_karyawan_id`, `user_username`, `user_password`, `user_akses_id`, `user_status`) VALUES
	...
	(4, 4, 'nobody', 'e10adc3949ba59abbe56e057f20f883e', 1, 'Aktif'),
